 ...
 * 아무것도 남기지 않는다. 그래서 늦게 들어온 사람에게 지난 감정이 뜨지 않고,
 * 새로고침하면 사라진다 — 실제로 말이 그런 것과 같다.
 *
 * **대신 같은 표현이 대화에도 한 줄로 남는다.** 보내는 쪽이 따로 할 일은 없다 —
 * 서버가 `emote` 와 `chat:message` 를 함께 쏜다. 판을 보고 있지 않던 사람에게도
 * 「누가 무엇을 보냈다」가 남아야 해서다.
 *
